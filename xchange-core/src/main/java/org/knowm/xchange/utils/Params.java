...
public final class Params implements Serializable {
    ...
    public  Params addAll( Map<String, Object> queries){
        data.putAll(queries);
        return  this;
    }
    ...
    public void digestAll(RestInvocation invocationParams) {
        for (String paramName : data.keySet()) {
            ...
            if (paramValue instanceof ParamSerialize) {
                data.put(paramName, ((ParamSerialize)paramValue ).toSerialize(invocationParams));
            }
        }
    }
